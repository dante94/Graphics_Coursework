...
ParticleEmitter::ParticleEmitter(void)	{
	...
	*/
	texture[0] = SOIL_load_OGL_texture("../../Textures/particle.tga",
	SOIL_LOAD_AUTO,SOIL_CREATE_NEW_ID,SOIL_FLAG_COMPRESS_TO_DXT);

	texture[0] = SOIL_load_OGL_texture(TEXTUREDIR"water.JPG",SOIL_LOAD_AUTO,SOIL_CREATE_NEW_ID,SOIL_FLAG_COMPRESS_TO_DXT);
}
...
Particle* ParticleEmitter::GetFreeParticle()	{
	...
	p->colour		= Vector4(1.0f,0.0f,1.0f,1.0f);
	p->direction	= initialDirection;
	p->direction.x += (1.0f) * particleVariance;
